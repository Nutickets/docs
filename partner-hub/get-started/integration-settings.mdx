...
Integrations also depend on [feature flags](/partner-hub/get-started/feature-flags) — the relevant feature flag must be enabled on both the reseller and the company before an integration can be activated.
...
<CardGroup cols={2}>
  ...
  <Card title="Gateway Settings" icon="credit-card" href="/partner-hub/get-started/gateway-settings">
