...
This follows the same [reseller funnelling](/partner-hub/get-started/feature-flags#reseller-funnelling) pattern as feature flags: gateways must be enabled on the reseller before they can be assigned to any of its companies.
...
Companies created through [self-service registration](/partner-hub/get-started/self-service-registration) are automatically assigned the reseller's first available payment gateway. The registering user does not select a gateway — it is inherited from the reseller.
...
Gateway configuration interacts with the [parent-child company](/partner-hub/get-started/parent-child-companies) hierarchy:
...
<CardGroup cols={2}>
  <Card title="Payment Processors" icon="credit-card" href="/core-platform/payments/payment-processors">
    Detailed documentation on each payment processor's capabilities and configuration at the company level.
  </Card>
  <Card title="Parent-Child Companies" icon="sitemap" href="/partner-hub/get-started/parent-child-companies">
