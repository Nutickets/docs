...
See [Plans & Packages](/partner-hub/get-started/plans-and-packages) for details on configuring plans.
...
<CardGroup cols={2}>
  ...
  <Card title="Trial Periods" icon="clock" href="/core-platform/get-started/trial-periods">
