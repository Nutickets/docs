...
<Note>
The ability to toggle between demo and live mode may be managed by your account manager. If you cannot see the toggle, or if the toggle is disabled, contact your account manager to request the change. A message will explain that the payment mode can only be changed by your account manager.
</Note>
