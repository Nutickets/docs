...
Scan-outs are produced wherever in/out scanning is used: in/out zones, the default [Entry](/core-platform/event-management/access-control#the-default-entry-zone) zone (when set to an in/out [scan mode](/core-platform/event-management/access-control#scan-modes)), [auto scan-out](/core-platform/event-management/access-control#auto-scan-out) times, and out-direction scans sent through the [Admit Entry Tickets](/api-reference/access-control/admit-entry-tickets) API.
