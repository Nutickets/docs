...
<Note>
  **Display area content** only appears on [large plans](/core-platform/seating-plans/introduction#plan-types), because only large plans use areas.
</Note>
...
| **Admin**  | The [event plan dashboard](/core-platform/event-management/seated-events#plan-dashboard) used to manage a seated event |
...
- The plan is not attached to any [event](/core-platform/event-management/seated-events). Once any event uses the plan, price bands can no longer be deleted.
