...
<Note>
SMS is a supplementary channel — email remains the primary notification method. When SMS is available, it is offered as an option during the approval or rejection action rather than replacing email.
</Note>
