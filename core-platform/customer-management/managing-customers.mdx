...
For programmatic customer management, use the [Customers](/api-reference/customers/retrieve-customers) API to create, retrieve, update, and delete customer records.
