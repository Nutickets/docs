...
For bulk operations, use the API to [add](/api-reference/customer-groups/add-customers-to-group) or [remove](/api-reference/customer-groups/remove-customers-from-group) multiple customers at once, or use the [customer data import](/core-platform/data-imports/overview) to set group membership via CSV.
...
<CardGroup cols={2}>
  ...
  <Card title="Data Imports" icon="file-import" href="/core-platform/data-imports/overview">
