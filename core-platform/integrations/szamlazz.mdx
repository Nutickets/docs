...
When a ticket is resold, the seller can contribute toward the [resale fees](/core-platform/resale/resale-fees) so the buyer pays less. Számlázz.hu documents reflect only the buyer's share of those fees:
