...
For the full list of events, their parameters, and what customer data each one carries, see [Embed Messages](/core-platform/technical/embed-messages). For how to set up an embed, see [Website Integration](/core-platform/technical/iframe-embeds).
...
- [Embed Messages](/core-platform/technical/embed-messages)
