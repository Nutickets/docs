...
Access codes can be imported via CSV through the [data import](/core-platform/data-imports/overview) workflow.
...
The **[Access Code Usage Report](/core-platform/reporting/default-reports#access-code-reports)** provides insight into how codes are being used. Available data includes:
...
- [Data Imports](/core-platform/data-imports/overview)
