...
| Report | Purpose |
|--------|---------|
| **[External Voucher Code Usage](/core-platform/reporting/default-reports#discount-code-reports)** | Shows usage per individual voucher code — including code, type, category, total discounted amount, and total uses |
| **[External Voucher Code Category Usage](/core-platform/reporting/default-reports#discount-code-reports)** | Shows aggregated usage per category — category name, total discounted amount, and total uses |
