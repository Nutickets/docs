...
For programmatic access, the API provides an endpoint to approve or reject order items — see the **Approve/reject order items** endpoint in the [API Reference](/api-reference/introduction).
