...
[Guest list](/core-platform/sale-items/guest-lists) items can always be configured to require approval, regardless of whether the feature flag is enabled. This is because guest list approval is a core part of the guest list workflow.
