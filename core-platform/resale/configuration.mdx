...
| Option | Label | Behaviour |
|--------|-------|-----------|
| **Enabled** | Enabled | Sellers receive automated emails at key stages of their resale journey — when a listing goes live and when items sell. |
...
The full wording of both notifications is editable through the [text manager](/core-platform/cms/website-text). Open the text manager and select the **Resale emails** category to edit subjects, headings, and body copy. Each entry supports translations, so you can localise resale notifications for multi-language shops.
