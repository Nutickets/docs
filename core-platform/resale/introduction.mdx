...
A listing is **Inactive** until its [purchase window](/core-platform/resale/configuration#time-windows) opens, then **Active** while buyers can purchase. From there it ends in one of four ways, each shown clearly as the listing's status:
