...
The platform supports 35+ currencies spanning Europe, the Americas, Asia-Pacific, and the Middle East — including GBP, EUR, USD, CAD, AUD, AED, SAR, and many more. Some currencies display prices without decimal places (e.g. Japanese Yen, Hungarian Forint); the platform handles decimal precision automatically.

<Accordion title="Full currency list">
