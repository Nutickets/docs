...
**Event pages** include: event name, start/end dates, venue name and address (if assigned), and organiser name. This can enable Google to show your events in event-specific search features, including the events carousel and Knowledge Panel.
