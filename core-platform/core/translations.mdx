...
<Note>
Admin users and hub users also have independent language preferences, saved to their respective accounts. Changing language in the admin area does not affect the shop, and vice versa.
</Note>
...
<CardGroup cols={2}>
  <Card title="Supported Languages" icon="globe" href="/core-platform/information/supported-languages">
