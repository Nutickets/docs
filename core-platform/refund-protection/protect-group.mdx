...
- In [attendance reports](/core-platform/reporting/default-reports#attendance-reports), with the ability to filter by protection status (protected, unprotected, claimed)
