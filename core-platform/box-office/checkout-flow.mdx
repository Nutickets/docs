...
If an event has [ticket naming](/core-platform/event-management/named-ticket-holders) enabled for box office, a step appears during checkout where staff can assign an attendee name to each ticket. This is controlled by per-event settings:
