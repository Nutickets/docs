...
<CardGroup cols={2}>
  ...
  <Card title="Single Sign-On" icon="key" href="/core-platform/system-access/single-sign-on">
    Let admin users sign in through your organisation's identity provider
  </Card>
</CardGroup>
