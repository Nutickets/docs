...
For the full list of specialised permissions — including event abilities like **Email attendees**, box office validation overrides, and per-payment-method controls — along with what each one does and the impact of granting it, see the Permissions Reference.

<Card title="Permissions Reference" icon="list-check" href="/core-platform/system-access/permissions-reference">
  Every permission, grouped by area, with what it controls and the impact of turning it on.
</Card>
...
<CardGroup cols={2}>
  <Card title="Permissions Reference" icon="list-check" href="/core-platform/system-access/permissions-reference">
    Every permission, grouped by area, with what each one controls
  </Card>
