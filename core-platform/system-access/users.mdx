...
The user can now sign in with their email and password. Users can also be [created](/api-reference/company-users/create-company-user), [updated](/api-reference/company-users/update-company-user), [suspended](/api-reference/company-users/suspend-company-user), and [restored](/api-reference/company-users/restore-company-user) via the API.
...
<Note>
When [Single Sign-On](/core-platform/system-access/single-sign-on) is enabled for your company, an **Authentication** section also appears when editing another user, letting you set whether they sign in with a password, through your identity provider, or both.
</Note>
