...
7. **Item sharing / Named holders** -- Shown if any items require [named ticket holders](/core-platform/event-management/named-ticket-holders) or compulsory transfers to other people.
...
| **Item sharing** | Items require [named ticket holders](/core-platform/event-management/named-ticket-holders) or compulsory transfers |
...
Feedback responses are available through the **[Order success customer feedback](/core-platform/reporting/default-reports#customer-feedback-reports)** report template, which provides:
