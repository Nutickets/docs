...
SSO is configured at the company level -- contact your account manager to set it up.

<Note>
For the developer side of this — the endpoints you host, the sign-in and sign-out round trips, and how to sign a customer into an embedded shop without a redirect — see [Signing Customers In](/integrate/identity/overview).
</Note>
