...
description: "Create mobile wallet designs and digital passes so customers can access their tickets from Apple Wallet or a web-based digital pass."
---

## Overview

Mobile wallet designs let you create branded digital passes for your customers' tickets. Customers can save their tickets directly to **Apple Wallet** on their iPhone, or — for events with [secure barcodes](/core-platform/event-management/secure-barcodes) — view them as a **digital pass** in their account.
...
<Note>
Apple Wallet integration remains **Apple Wallet only** — there is no Google Wallet integration at this time. However, the new digital pass (available for events with secure barcodes) works on any device via the customer's account.
</Note>
