...
[Data capture](/core-platform/data-capture/introduction) for team events uses the same question types and [assignment levels](/core-platform/data-capture/assigning-questions) as standard events, but the checkout flow adjusts which questions are shown based on the customer's team role.
