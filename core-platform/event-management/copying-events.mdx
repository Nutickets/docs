...
- Setting up recurring events without using [schedules](/core-platform/event-management/schedules)
...
<Note>You must have permission to create events to access this feature.</Note>
...
- [Event Scheduling](/core-platform/event-management/schedules) — For creating recurring event series
