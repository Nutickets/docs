...
Once you've created a data endpoint, you can assign it to any [scheduled report](/user-manual/reporting/scheduled-reports):
...
<CardGroup cols={2}>
  ...
  <Card title="Custom Reports" icon="chart-bar" href="/user-manual/reporting/custom-reports">
    Build the reports you want to publish to data endpoints.
  </Card>
  <Card title="Reporting Fundamentals" icon="magnifying-glass-chart" href="/user-manual/reporting/fundamentals">
