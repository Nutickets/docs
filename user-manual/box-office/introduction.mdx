...
| Setting | Description |
|---------|-------------|
| **Enable box office guest checkout** | Controls whether staff must assign a customer to orders. Three modes: guest checkout allowed, name only required, or full customer required. See [Checkout Flow](/user-manual/box-office/checkout-flow). |
