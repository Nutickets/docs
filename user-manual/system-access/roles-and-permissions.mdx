...
- **Users** include **Access** (for [accessing another user's account](/user-manual/system-access/users#accessing-a-users-account))
...
<Card title="Permissions Reference" icon="list-check" href="/user-manual/system-access/permissions-reference">
