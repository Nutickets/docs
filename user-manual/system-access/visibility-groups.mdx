...
This separation is important: [roles and permissions](/user-manual/system-access/roles-and-permissions) determine *what a user can do* (edit events, process refunds, manage users), while visibility groups determine *which records they can do it on*.
...
Visibility groups are assigned to users during [user creation](/user-manual/system-access/users#adding-a-user) or editing:
...
Event assignment is managed from the [user's detail page](/user-manual/system-access/users#assigning-events-to-users). The user gains access to the assigned events in addition to everything their visibility groups already provide.
