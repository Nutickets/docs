...
Who actually pays these fees — the buyer, the seller, or both — is controlled by the [fee payer](/user-manual/resale/configuration#fee-payer) setting in your resale configuration.
...
Who pays resale fees is controlled by the [fee payer](/user-manual/resale/configuration#fee-payer) setting in your resale configuration, not on the individual fee item. The four options are:
...
For full details on configuring fee payer settings, see [Resale Configuration](/user-manual/resale/configuration#fee-payer).

## Fee Transparency

How buyers see resale fees in the basket is controlled by the [fee transparency](/user-manual/resale/configuration#fee-transparency) setting:
