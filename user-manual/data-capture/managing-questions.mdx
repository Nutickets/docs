...
| Required | `required` | Field must be completed — this can also be controlled via field assignment settings when [assigning the question](/user-manual/data-capture/assigning-questions#field-settings) |
