...
Forms let you create standalone data capture pages on your ticket shop — contact forms, enquiry forms, registration forms, or any custom form you need. Each form gets its own URL, collects responses through your existing [data capture](/user-manual/data-capture/introduction) questions, and can route submissions to email recipients and external services.
...
Questions support various field types — text, email, phone, dropdowns, checkboxes, and more. See [Data Capture](/user-manual/data-capture/introduction) for details on creating and configuring questions.
...
See [Webhooks](/user-manual/technical/webhooks) for details on configuring webhook endpoints.
...
<CardGroup cols={2}>
  <Card title="Data Capture" icon="clipboard-question" href="/user-manual/data-capture/introduction">
    Create and manage the questions used in your forms
  </Card>
  <Card title="Webhooks" icon="webhook" href="/user-manual/technical/webhooks">
