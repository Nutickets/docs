...
- Sales periods also drive dynamic content on the event page — [content blocks](/user-manual/event-management/event-page-customisations) can be shown or hidden based on the current sale phase.
- All sales period dates respect the event's [timezone](/user-manual/core/timezones).

<Note>
Sales periods require the event sale periods feature to be enabled for your company. Without this feature, event sales are controlled by manually toggling the event on or off sale and by setting on-sale dates on individual [sale items](/user-manual/sale-items/core-concepts), [timeslots](/user-manual/event-management/timeslots), and [sale item groups](/user-manual/event-management/sale-item-groups).
</Note>
...
Sales periods integrate with [event page customisations](/user-manual/event-management/event-page-customisations) to control when content blocks appear on the event page. Each content block can be configured with a visibility rule tied to the current sale phase:
...
- [Event Page Customisations](/user-manual/event-management/event-page-customisations)
- [Timezones](/user-manual/core/timezones)
