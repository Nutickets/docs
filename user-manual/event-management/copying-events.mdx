...
- Setting up recurring events without using [schedules](/user-manual/event-management/schedules)
...
- [Event Scheduling](/user-manual/event-management/schedules) — For creating recurring event series
