...
Custom URLs are managed in the **Custom site URLs** section of **Settings > General settings**. The section only appears when custom URLs are enabled for your account.

1. Navigate to **Settings > General settings**
2. In **Custom site URLs**, click **Add new URL**
3. Fill in the required fields:

| Field | Description | Example |
|-------|-------------|---------|
| **Full URL** | The complete URL including any subdomains. Do not include `http://` or `https://` | `tickets.example.com` |
| **Base domain** | The root domain portion of your URL. If no subdomain is used, this is the same as the full URL | `example.com` |
...
| **System domain conflict** | Rejected if the URL matches an existing company's default site URL (its site alias combined with the platform's domain) |
...
<CardGroup cols={2}>
  <Card title="Ticket Shop Homepage" icon="store" href="/user-manual/ticket-shop/homepage">
