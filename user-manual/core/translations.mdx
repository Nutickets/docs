...
| **Company settings** | Logo (dark and light), meta/sharing image, [default image](/user-manual/cms/theme-and-branding#default-images), default event header, default event thumbnail, default sharing image, default schedule header, default item image |
...
For full details on creating overrides, scoping them, and understanding priority resolution, see [Website Text](/user-manual/cms/website-text).
...
<CardGroup cols={2}>
  <Card title="Website Text" icon="font" href="/user-manual/cms/website-text">
    Scoped text overrides for events, schedules, and customer groups
  </Card>
  <Card title="SEO & Sharing" icon="share-nodes" href="/user-manual/core/seo">
