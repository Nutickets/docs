...
2. The system checks whether the email belongs to an existing account:
   ...
   - **New customer** — they are offered the option to **Continue as guest** (if [guest checkout](/user-manual/ticket-shop/checkout#guest-checkout) is enabled) or to create an account
...
For full details on how balances, top-ups, and cash outs work, see the [Account Balances](/user-manual/account-balances/top-ups) documentation.
...
<Note>
Restricted content is commonly used alongside [customer groups](/user-manual/customer-management/customer-groups) to offer exclusive items or early access to specific audiences. Customers must both be signed in and belong to the correct group to see restricted items.
</Note>

## Related Pages

- [Checkout](/user-manual/ticket-shop/checkout) -- The full checkout process including guest checkout
- [Customer Management](/user-manual/customer-management/managing-customers) -- Admin-side customer management
- [Customer Groups](/user-manual/customer-management/customer-groups) -- Grouping customers for access control and pricing
- [Account Balances](/user-manual/account-balances/top-ups) -- Top-ups and balance management
- [Item Transfers](/user-manual/event-management/item-transfers) -- Transferring tickets between customers
- [Marketing Preferences](/user-manual/notifications/email-settings) -- Email notification settings
