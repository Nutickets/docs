...
1. **Basket review** -- Always shown. The customer reviews their items, quantities, and pricing. Discount codes are applied here. [Access codes](/user-manual/basket-codes/access-codes#entering-an-access-code) are entered earlier, while the customer chooses items.
...
7. **Item sharing / Named holders** -- Shown if any items require [named ticket holders](/user-manual/event-management/named-ticket-holders) or compulsory transfers to other people.
...
<Accordion title="Step visibility quick reference">
...
| **Item sharing** | Items require [named ticket holders](/user-manual/event-management/named-ticket-holders) or compulsory transfers |
...
2. Find **Allow shop guest checkout**
...
<Note>
The setting description reads: "When on, customers can check out in the shop without creating an account." This is enabled by default.
</Note>
...
1. Navigate to **Company Settings**
2. Find **Log guest customers out after checkout**
3. Toggle the setting on
...
<Note>
The setting description reads: "Guest customers are signed out automatically once checkout finishes or their basket expires. Useful on shared devices like a kiosk."
</Note>
...
Feedback responses are available through the **[Order success customer feedback](/user-manual/reporting/default-reports#customer-feedback-reports)** report template, which provides:
...
- [Basket](/user-manual/ticket-shop/basket) -- Basket management before checkout
- [Payment Processors](/user-manual/payments/payment-processors) -- Gateway configuration
- [Data Capture](/user-manual/data-capture/introduction) -- Custom questions setup
- [Customer Accounts](/user-manual/ticket-shop/customer-accounts) -- Account creation and login
