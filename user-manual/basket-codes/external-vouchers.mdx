...
Unlike regular [discount codes](/user-manual/basket-codes/discount-codes), external vouchers:
...
| Report | Purpose |
|--------|---------|
| **[External Voucher Code Usage](/user-manual/reporting/default-reports#discount-code-reports)** | Shows usage per individual voucher code — including code, type, category, total discounted amount, and total uses |
| **[External Voucher Code Category Usage](/user-manual/reporting/default-reports#discount-code-reports)** | Shows aggregated usage per category — category name, total discounted amount, and total uses |
