...
- Apply [discount codes](/user-manual/basket-codes/discount-codes) or [access codes](/user-manual/basket-codes/access-codes)
- Add or remove items (unless the API request flagged items as non-modifiable)
- Proceed through [checkout](/user-manual/ticket-shop/checkout) and payment
...
- **Customer context only** — basket links are for customer use; they cannot be activated in [box office](/user-manual/box-office/introduction) mode
