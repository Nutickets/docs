...
| **Send a payment reminder before the deadline** | How long before the balance deadline to email the customer a reminder to pay the remaining balance, in hours, days, or weeks (up to four weeks). Set to 0 to turn reminders off — they are off by default. See [Payment Reminders](/user-manual/notifications/payment-reminders). <Tip>New in Release 48</Tip> |
