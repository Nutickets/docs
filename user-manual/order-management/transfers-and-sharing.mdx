...
| **Keep the original barcode on transfer** | When enabled, barcodes are kept the same during instant transfers. When disabled, new barcodes are generated on claim. |
