...
- **Order is frozen** — If the order is currently frozen (e.g. during an [order modification](/user-manual/order-management/order-modifications)), all distribution operations are blocked until the order is unfrozen.
...
- [Item Transfers (Event Configuration)](/user-manual/event-management/item-transfers) — Sharing restrictions, compulsory transfers, and named holders
