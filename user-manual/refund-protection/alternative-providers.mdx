...
Manual refund protection provides a flexible alternative to the [Protect Group integration](/user-manual/refund-protection/protect-group). Instead of connecting to an external API that handles pricing and claims automatically, you define your own protection fee items with custom pricing, descriptions, and terms. Customers see these as selectable options during checkout and can choose one to add to their order.
...
<CardGroup cols={2}>
  <Card title="Protect Group" icon="shield-check" href="/user-manual/refund-protection/protect-group">
