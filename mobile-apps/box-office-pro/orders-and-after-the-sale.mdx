...
After completing a sale, Box Office Pro provides tools for managing orders, issuing refunds, checking in attendees, pairing tickets to NFC wristbands, and printing receipts. The **Orders** screen is accessed from the main menu.
