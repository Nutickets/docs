...
Box Office Pro is the mobile ticket-selling app for on-site and walk-up sales. Staff browse events, select tickets, process payments, and issue orders — all from a handheld Android device. It brings the same capabilities as the [web-based box office mode](/user-manual/box-office/introduction) to a portable form factor.
...
<CardGroup cols={2}>
  <Card title="Box Office Mode (Web)" icon="desktop" href="/user-manual/box-office/introduction">
