...
Box Office Pro is the mobile ticket-selling app for on-site and walk-up sales. Staff browse events, select tickets, process payments, and issue orders — all from a handheld Android device. It brings the same capabilities as the [web-based box office mode](/core-platform/box-office/introduction) to a portable form factor.
