...
| **Season tickets** | [Season passes](/user-manual/sale-items/season-tickets) only |
| **Bundles** | Items that include [bundled contents](/user-manual/sale-items/bundles) |
...
If the event uses [timeslots](/user-manual/event-management/timeslots), a header at the top of the ticket list lets you choose which timeslot to shop:
...
| Descriptor | Meaning |
|-------|---------|
| **Bundle** | Ticket includes one or more [bundled items](/user-manual/sale-items/bundles) at a fixed price |
| **Season ticket** | A [season pass](/user-manual/sale-items/season-tickets) rather than a single-event ticket |
| **Product** | A physical product rather than a ticket |
| **Has add-ons** | Optional [add-on](/user-manual/sale-items/add-ons) items are available for this ticket |
...
<Note>
If any selected ticket has optional [add-ons](/user-manual/sale-items/add-ons), the **Add to basket** flow shows the add-on selection dialog before the basket opens. The **Checkout** flow skips add-on selection — use **Add to basket** when add-ons need to be chosen.
</Note>
...
Tap the **Add code** icon to apply a [discount code](/user-manual/basket-codes/discount-codes). A dialog asks for the code — enter it and tap **Apply**. On success, the basket total updates and a confirmation appears: *"Discount code applied successfully."*
