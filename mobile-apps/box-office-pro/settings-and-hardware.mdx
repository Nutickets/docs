...
Box Office Pro settings control which payment methods are available, how the app interacts with hardware, and optional features like kiosk mode and NFC pairing. Settings are accessed from the menu on the event listing screen.
