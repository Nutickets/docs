...
The core workflow in EPOS Pro is selling products. Staff select items from the shop's product catalogue, review the basket, choose a payment method, and complete the transaction. The app supports five payment methods, product categories, custom pricing, age verification, and an auto-sale mode for high-volume single-product selling.
...
<CardGroup cols={2}>
  <Card title="Top-Ups & Cash Out" icon="wallet" href="/mobile-apps/epos-pro/topups-and-cashout">
